/**
 * Sectional configuration diagram cards ΓÇö AUTO-GENERATED by
...
(function () {
  ...
  /* MC_SECTIONAL_PDP_TOP_PRICE_CSS_20260531a ΓÇö MTL renderer owns top price panel layout */
  (function (d) {
  ...
  /* MC_SECTIONAL_PDP_AUTH_INLINE_20260623sarrepair1 ΓÇö DISABLED: template owns mc-pdp-auth-cta-fix load; reload caused blank Saranoni PDPs */
  (function () {
    return;
  })();

  /* MC_SECTIONAL_MTL_RENDERER_INLINE ΓÇö GitHub raw first (Volusion file body lags ?v= cache bust) */
  (function (g, d) {
