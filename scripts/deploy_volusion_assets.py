...
OPTIONAL = (
    ...
    "vspfiles/imports/steve-silver-volusion/README.md",
    "vspfiles/imports/steve-silver-volusion/servers_on_site_format_notes.csv",
    "vspfiles/imports/steve-silver-volusion/steve_silver_dining_groups_import.csv",
    "vspfiles/imports/steve-silver-volusion/steve_silver_game_dining_server_import.csv",
    "vspfiles/imports/steve-silver-volusion/steve_silver_game_dining_server_import.xlsx",
    "vspfiles/imports/steve-silver-volusion/steve_silver_game_table_sets_import.csv",
    "vspfiles/imports/steve-silver-volusion/summary.json",
