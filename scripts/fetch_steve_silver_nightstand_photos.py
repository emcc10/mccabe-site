#!/usr/bin/env python3
"""Download Steve Silver bedroom nightstand photos for Volusion PLP/PDP.
...
Outputs: vspfiles/photos/SS-*NS*-1.jpg and SS-*NS*-2.jpg
"""
...
PIECE_MARKERS = ("_WS", "_VG1", "_VG2", "NIGHTSTAND", "900NS")

NIGHTSTAND_PRODUCTS: dict[str, dict[str, str]] = {
    "SS-BC900NS": {
        "page": "https://stevesilver.com/product/bear-creek-nightstand/",
        "sku": "BC900NS",
        "room_page": "https://stevesilver.com/product/bear-creek-4-piece-king-setk-bed-ns-dresser-mir/",
    },
    "SS-BC950NSB": {
        "page": "https://stevesilver.com/product/bear-creek-nightstand-brown/",
        "sku": "BC950NSB",
    },
    "SS-CAS900NS": {
        "page": "https://stevesilver.com/product/cassie-illuminating-glam-nightstand-shimmering-pearl-finish/",
        "sku": "CAS900NS",
        "room_page": "https://stevesilver.com/product/cassie-illuminating-4-piece-glam-king-set/",
    },
    "SS-HP900NSW": {
        "page": "https://stevesilver.com/product/highland-park-nightstand-cathedral-white/",
        "sku": "HP900NSW",
    },
    "SS-HP900NSD": {
        "page": "https://stevesilver.com/product/highland-park-nightstand-waed-driftwood/",
        "sku": "HP900NSD",
    },
    "SS-MON900NSS": {
        "page": "https://stevesilver.com/product/montana-nightstand-sand/",
        "sku": "MON900NSS",
    },
    "SS-RV900NS": {
        "page": "https://stevesilver.com/product/riverdale-nightstand/",
        "sku": "RV900NS",
        "room_page": "https://stevesilver.com/product/riverdale-4-piece-king-storage-bedroom-set/",
    },
    "SS-SIG900NS": {
        "page": "https://stevesilver.com/product/sigmund-nightstand/",
        "sku": "SIG900NS",
...
def piece_score(alt: str, url: str, sku: str) -> int:
    ...
    if "_VG2" in text:
        score += 70
    if "NIGHTSTAND" in text and "BRREG" not in text:
        score += 60
    if matches_sku(alt, url, sku):
        score += 30
...
def main() -> int:
    ...
    products = NIGHTSTAND_PRODUCTS
    if args.code:
        products = {k: v for k, v in NIGHTSTAND_PRODUCTS.items() if k in args.code}
    ...
    print("Deploy: push vspfiles/photos/SS-*NS*.jpg (deploy-plp-photos or full deploy)")
