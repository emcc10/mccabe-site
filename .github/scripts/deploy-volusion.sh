...
if [[ -z "$TEMPLATE_ENFORCER_TAG" ]]; then
  TEMPLATE_ENFORCER_TAG="mc-plp-enforcer.js?v=20260613"
fi
...
verify_url "https://www.mccabestheaterandliving.com/v/vspfiles/js/mc-plp-enforcer.js?v=20260613" "MC_PLP_ENFORCER_20260613"
verify_url "https://www.mccabestheaterandliving.com/v/vspfiles/templates/266/js/mc-plp-enforcer.js?v=20260613" "MC_PLP_ENFORCER_20260613"
verify_url "https://www.mccabestheaterandliving.com/v/vspfiles/templates/266/js/min/design-toolkit.min.js" "MC_DTK_PLP_20260613"
