...
(function (global) {
  ...
  function ensurePdpTitleInOptionsColumn() {
    /* Soft-goods brands: always re-home the breadcrumb H1 into the info column
       so the product name stays below the brand logo (and never above the hero). */
    if (
      isPdpLayoutMounted() &&
