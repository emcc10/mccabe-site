...
(function (global) {
  ...
  // MC_PDP_AUTH_DEPLOY_VERIFY_20260622saracc3
  var VERSION = "20260622saracc3";
  ...
  function ensureUnifiedPdpLayout() {
    ...
    try {
      var s = global.document.createElement("script");
      s.src = "/v/vspfiles/js/mc-unified-pdp-layout.js?v=20260622saracc3&mcrd=" + Date.now();
      s.onload = function () {
...
(function (g, d) {
  var SS_ALT_VER = "20260622saracc3";
...
(function (g, d) {
  var CENTER_ALT_VER = "20260622saracc3";
